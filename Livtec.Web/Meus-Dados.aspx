                        ...
                        <asp:UpdatePanel runat="server" ID="UpdtPanelRegisto">
                            <ContentTemplate>
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" ID="TBPasswordAtualAlteracao" TextMode="Password" class="form-control rounded-0" placeholder="A sua antiga password" />
                                    <asp:RequiredFieldValidator runat="server"
                                        CssClass="text-danger text-center m-0"
                                        ControlToValidate="TBPasswordAtualAlteracao"
                                        ErrorMessage="A antiga password é de preenchimento obrigatório!"
                                        SetFocusOnError="true"
                                        ValidationGroup="VGAlterarPassword"
                                        Display="Dynamic" />
                                </div>

                                <div class="form-group">
                                    <label for="TBNovaPasswordAlteracao" class="col-form-label">Nova Password</label>
                                    <asp:TextBox runat="server" ID="TBNovaPasswordAlteracao" TextMode="Password" class="form-control rounded-0" placeholder="A sua nova password" />
                                    <asp:RequiredFieldValidator runat="server"
                                        CssClass="text-danger text-center m-0"
                                        ControlToValidate="TBNovaPasswordAlteracao"
                                        ErrorMessage="A nova password é de preenchimento obrigatório!"
                                        SetFocusOnError="true"
                                        ValidationGroup="VGAlterarPassword"
                                        Display="Dynamic" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" ID="TBNovaPasswordConfirmacaoAlteracao" TextMode="Password" class="form-control rounded-0" placeholder="Confirme a sua nova password" />
                                    <asp:RequiredFieldValidator runat="server"
                                        CssClass="text-danger text-center m-0"
                                        ControlToValidate="TBNovaPasswordConfirmacaoAlteracao"
                                        ErrorMessage="A confirmação da nova password é de preenchimento obrigatório!"
                                        SetFocusOnError="true"
                                        ValidationGroup="VGAlterarPassword"
                                        Display="Dynamic" />
                                    <asp:CompareValidator runat="server"
                                        CssClass="text-danger text-center m-0"
                                        ControlToValidate="TBNovaPasswordAlteracao"
                                        ErrorMessage="A confirmação da nova password tem que ser igual à nova password introduzida!"
                                        ControlToCompare="TBNovaPasswordConfirmacaoAlteracao"
                                        SetFocusOnError="true"
                                        ValidationGroup="VGAlterarPassword"
                                        Display="Dynamic" />
                                </div>

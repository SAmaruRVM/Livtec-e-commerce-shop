<%@ Page Title="" Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="Minhas-Encomendas.aspx.cs" Inherits="Livtec.Web.Minhas_Encomendas" %>
        ...
        <div class="row">
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <ul class="list-group mb-3">
                    <asp:Repeater runat="server" ID="RptrEncomendas">
                        <ItemTemplate>
